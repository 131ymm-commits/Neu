...
T = float(sys.argv[1]); seed = int(sys.argv[2]); STEPS = 5_000_000; EVERY = 50; dt = 0.005; gamma = 2.0
...
np.savez_compressed(f'/home/claude/net01L_T{T:.2f}_s{seed}.npz', Ep=Ep, D=Dp, Eis=Eis)
